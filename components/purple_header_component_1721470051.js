...
Vue.component("purple_header_component_1721470051", {
    template: `
            ...
            <div class="flex items-center justify-between h-16 md:h-20">
                ...
                <nav id="desktop-navigation" class="hidden md:flex md:grow">
                    ...
                    <ul id="desktop-menu-links" class="flex grow justify-center flex-wrap items-center">
                        <li><a id="Buy Fresh-link" class="font-medium text-sm mx-4 lg:mx-5 transition duration-150 ease-in-out" :class="[textStylePrimary, hoverTextStylePrimary]" href="Buy Fresh.html">Buy Fresh</a></li>
                        <li><a id="Sell Surplus-link" class="font-medium text-sm mx-4 lg:mx-5 transition duration-150 ease-in-out" href="Sell Surplus.html" :class="[textStylePrimary, hoverTextStylePrimary]">Sell Surplus</a></li>
                        <li><a id="Community Hub-link" class="font-medium text-sm mx-4 lg:mx-5 transition duration-150 ease-in-out" href="Community Hub.html" :class="[textStylePrimary, hoverTextStylePrimary]">Community Hub</a></li>
                ...
                <div id="mobile-menu" class="md:hidden flex items-center ml-4" x-data="{ expanded: false }">
                    ...
                    <nav id="mobile-nav" class="absolute top-full z-20 left-0 w-full px-4 sm:px-6 overflow-hidden transition-all duration-300 ease-in-out" x-ref="mobileNav" :style="expanded ? 'max-height: ' + $refs.mobileNav.scrollHeight + 'px; opacity: 1' : 'max-height: 0; opacity: .8'" @click.outside="expanded = false" @keydown.escape.window="expanded = false" x-cloak>
                        <ul id="mobile-nav-list" class="border border-transparent rounded-lg px-4 py-1.5" :class="signUpButtonGradient">
                            <li><a id="mobile-Buy Fresh-link" class="flex font-medium text-sm py-1.5" href="Buy Fresh.html" :class="[textStylePrimary,hoverTextStylePrimary]">Buy Fresh</a></li>
                            <li><a id="mobile-Sell Surplus-link" class="flex font-medium text-sm py-1.5" href="Sell Surplus.html" :class="[textStylePrimary,hoverTextStylePrimary]">Sell Surplus</a></li>
                            <li><a id="mobile-Community Hub-link" class="flex font-medium text-sm py-1.5" href="Community Hub.html" :class="[textStylePrimary,hoverTextStylePrimary]">Community Hub</a></li>
